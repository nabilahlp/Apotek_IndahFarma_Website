  ...
  <div class="row">
    ...
    elseif ($_GET['alert'] == 2) {
      echo "<div class='alert alert-success alert-dismissable'>
              <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
              <h4>  <i class='icon fa fa-check-circle'></i> Sukses!</h4>
              Data obat berhasil diubah pada " . date("d/m/Y") . " pukul" . date(" G:i:s") . 
              " oleh <strong>$data[nama_user]</strong>.
            </div>";
    }
    // jika alert = 3
          ...
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            <thead>
              <tr>
                ...
                <th class="center">Tanggal Kadaluarsa</th>
            ...
            $query = mysqli_query($mysqli, "SELECT kode_obat,nama_obat,harga_jual,bentuk_obat, tgl_produksi, tgl_kadaluarsa FROM obat ORDER BY kode_obat ASC")
            ...
            // tampilkan data
              ...
              echo "<tr>
                      ...
                      <td width='180' align='center'>$data[nama_obat]</td>
                      
                      <td width='100' align='center'>Rp $harga_jual</td>
