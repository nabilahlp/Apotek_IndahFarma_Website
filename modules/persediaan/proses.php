...
// jika user sudah login, maka jalankan perintah untuk insert, update, dan delete
    ...
    if ($_GET['act']=='insert') {
        if (isset($_POST['simpan'])) {
            ...
            $query = mysqli_query($mysqli, "INSERT INTO persediaan(kode_obat, jumlah_sedia, created_user, updated_user) 
                                            VALUES('$kode_obat','$jumlah_sedia','$created_user',
                                            '$created_user')")
    ...
    elseif ($_GET['act']=='update') {
        if (isset($_POST['simpan'])) {
            if (isset($_POST['kode_obat'])) {
                ...
                $kode_obat  = mysqli_real_escape_string($mysqli, trim($_POST['kode_obat']));
                $jumlah_sedia  =
                mysqli_real_escape_string($mysqli, trim($_POST['jumlah_sedia']));
