...
$query = mysqli_query($mysqli, "SELECT kode_obat,nama_obat,harga_jual,bentuk_obat,stok FROM obat ORDER BY nama_obat ASC")
    ...
    <body>
            ...
            <table width="100%" border="0.3" cellpadding="0" cellspacing="0">
                <thead style="background:#e8ecee">
                    <tr class="tr-title">
                        ...
                        <th height="20" align="center" valign="middle">bentuk obat</th>
                    </tr>
                </thead>
                <tbody>
        <?php
        ...
        while ($data = mysqli_fetch_assoc($query)) {
            ...
            echo "  <tr>
                        ...
                        <td width='80' height='13' align='center' valign='middle'>$data[bentuk_obat]</td>
                    </tr>";
            $no++;
        }
        ?>  
...
require_once('../../assets/plugins/html2pdf_v4.03/html2pdf.class.php');
    ...
    if (preg_match("/MSIE/i", $_SERVER["HTTP_USER_AGENT"])){
        ...
        $pdf->Output($filename, 'I'); //Outputs on browser screen
?>